...
///
/// \sa Calendar, DateTimePicker, StringProperties
//////////////////////////////////////////////////////////////////////
...
public:
	...
	CommonProperties();
		...
		BEGIN_MSG_MAP(CommonProperties)
			...
			NOTIFY_CODE_HANDLER(DTN_DATETIMECHANGE, OnPickerDateTimeChangeNotification)
...
protected:
	...
	///
	/// Will be called if a date-time picker's date was changed. We use this handler to set the dirty flag.
	///
	/// \sa <a href="https://msdn.microsoft.com/en-us/library/bb761737.aspx">DTN_DATETIMECHANGE</a>
	LRESULT OnPickerDateTimeChangeNotification(int /*controlID*/, LPNMHDR /*pNotificationDetails*/, BOOL& /*wasHandled*/);
	...
	struct Controls
	{
		...
		/// \brief <em>Wraps the date-time picker displaying the value of the \c MinDate property</em>
		CDateTimePickerCtrl minDatePicker;
		/// \brief <em>Wraps the date-time picker displaying the value of the \c MaxDate property</em>
		CDateTimePickerCtrl maxDatePicker;
	...
	struct Properties
	{
		...
		/// \brief <em>Holds the number of \c DateTimePicker controls this property page refers to</em>
		int numberOfDateTimePickers;

		Properties()
		{
			hWndCheckMarksAreSetFor = NULL;
			numberOfDateTimePickers = 0;
		}
	} properties;
