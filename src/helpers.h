...
/// \brief <em>Calculates the number of days in the specified month</em>
///
/// \param[in] pSystemTime The month for which to calculate the number of days.
///
/// \return The number of days in the specified month.
int GetMonthDays(__in LPSYSTEMTIME pSystemTime);