...
///
/// \if UNICODE
///   \sa DTCtlsLibU::IOLEDataObject, Calendar, DateTimePicker,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa DTCtlsLibA::IOLEDataObject, Calendar, DateTimePicker,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE TargetOLEDataObject : 
    ...
    #ifdef UNICODE
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_DTCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #else
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_DTCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #endif
{
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, Calendar::get_SupportOLEDragImages,
	///       DateTimePicker::get_SupportOLEDragImages, DTCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa SetDropDescription, Calendar::get_SupportOLEDragImages,
	///       DateTimePicker::get_SupportOLEDragImages, DTCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, Calendar::put_SupportOLEDragImages,
	///       DateTimePicker::put_SupportOLEDragImages, DTCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription, Calendar::put_SupportOLEDragImages,
	///       DateTimePicker::put_SupportOLEDragImages, DTCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
