// DTCtls.cpp: Implementation of DLL exports.
...
class DTCtlsModule :
    public CAtlDllModuleT<DTCtlsModule>
{

public:
  #ifdef _UNICODE
		DECLARE_LIBID(LIBID_DTCtlsLibU)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_DTCTLS, "{F5BFB865-9B74-4824-9BED-8FCB326C0A9B}")
	#else
		DECLARE_LIBID(LIBID_DTCtlsLibA)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_DTCTLS, "{C23E2DCD-75B0-4c30-B424-8E42738C694D}")
	#endif
};

DTCtlsModule _AtlModule;
